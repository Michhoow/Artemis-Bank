...
namespace ArtemisBank.Core.Application.ViewModels.Cashier
{
    ...
    /// <summary>Pantalla de confirmacion previa comun a las operaciones del cajero.</summary>
    public class CashierConfirmViewModel
    {
        /// <summary>Deposito | Retiro | PagoTarjeta | PagoPrestamo | Terceros.</summary>
        ...
        /// <summary>Monto digitado por el cajero.</summary>
        public decimal EnteredAmount { get; set; }
        /// <summary>Monto que realmente sera debitado y aplicado (regla anti sobrepago).</summary>
