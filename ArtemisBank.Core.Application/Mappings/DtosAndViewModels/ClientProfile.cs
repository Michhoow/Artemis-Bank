...
{
    /// <summary>
    /// Mapeo de los contratos compartidos hacia los ViewModels del cliente.
    /// La tarjeta se proyecta SIEMPRE enmascarada: el numero completo nunca sale del modulo de tarjetas.
    /// </summary>
