...
{
    /// <summary>GET /api/credit-card — listado paginado de tarjetas con filtros.</summary>
    public class GetCreditCardsQuery : IRequest<PagedResult<CreditCardListItemDto>>
    {
    ...
    public class GetCreditCardsQueryValidator : AbstractValidator<GetCreditCardsQuery>
    {
        ...
        public GetCreditCardsQueryValidator()
        {
            ...
            RuleFor(q => q.PageSize)
                ...
                .LessThanOrEqualTo(PagedResult<CreditCardListItemDto>.MaxPageSize)
    ...
    public class GetCreditCardsQueryHandler
        : IRequestHandler<GetCreditCardsQuery, PagedResult<CreditCardListItemDto>>
    {
        private readonly ICreditCardService _service;

        public GetCreditCardsQueryHandler(ICreditCardService service) => _service = service;

        public Task<PagedResult<CreditCardListItemDto>> Handle(GetCreditCardsQuery request,
