...
{
    /// <summary>POST /api/savings-account — asigna una cuenta SECUNDARIA a un cliente activo.</summary>
    public class CreateSecondarySavingsAccountCommand : IRequest<SavingsAccountDto>
    {
        public string ClientId { get; set; } = string.Empty;
        public decimal InitialBalance { get; set; }
        /// <summary>Administrador autenticado responsable de la asignacion (se toma del JWT/sesion).</summary>
