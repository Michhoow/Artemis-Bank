...
namespace ArtemisBank.Infrastructure.Persistence.EntityConfigurations
{
    public class TransactionEntityConfiguration : IEntityTypeConfiguration<Transaction>
    {
        public void Configure(EntityTypeBuilder<Transaction> builder)
        {
            ...
            // Origen y Beneficiario son TEXTO mostrable: numero de cuenta, "DEPOSITO",
            // "RETIRO", ultimos 4 digitos de tarjeta o numero de prestamo.
            ...
            // Historial de una cuenta, de la mas reciente a la mas antigua.
            builder.HasIndex(t => new { t.SavingsAccountId, t.CreatedAt });

            // Indicadores del Home del administrador (conteo por operacion distinta).
