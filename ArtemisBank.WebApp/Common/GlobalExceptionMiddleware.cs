...
namespace ArtemisBank.WebApp.Common
{
    ...
    /// Para peticiones AJAX responde Problem Details (RFC 7807); para navegacion normal
    /// redirige a la pantalla de error. Los errores no controlados quedan registrados por Serilog
    /// antes de responder y nunca exponen el detalle interno al usuario.
    /// </summary>
