...
{
    /// <summary>Transferencia entre cuentas de ahorro propias del cliente autenticado.</summary>
    ...
    public class TransferController : BaseController
    {
        ...
        public async Task<IActionResult> Index(CancellationToken cancellationToken)
        {
            ...
            // Se necesitan al menos dos cuentas activas para mover fondos entre cuentas propias.
