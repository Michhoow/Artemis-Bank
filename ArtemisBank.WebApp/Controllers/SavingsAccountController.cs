...
{
    /// <summary>
    /// Gestion de cuentas de ahorro (administrador).
    /// Desde aqui SOLO se asignan cuentas secundarias: la principal la crea el modulo de usuarios.
    /// </summary>
    ...
    public class SavingsAccountController : BaseController
    {
        ...
        public async Task<IActionResult> Cancel(string accountNumber, CancellationToken cancellationToken)
        {
            ...
            // Las cuentas principales no se cancelan ni por acceso directo a la URL.
